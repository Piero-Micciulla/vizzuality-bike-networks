...
const StationCard = ({ station }: Props) => {
  return (
    <li
      className="flex justify-between items-center p-2 py-8 border-b border-dotted border-b-[1px] hover:pl-4 hover:bg-white/30 transition-all duration-200 cursor-default"
      role="listitem"
      aria-label={`Station ${station.name}, ${station.free_bikes} free bikes, ${station.empty_slots} empty slots`}
    >
